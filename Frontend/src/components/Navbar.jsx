...
function Navbar() {
  ...
  className={`max-w-screen-2xl container dark:bg-slate-900 dark:text-white mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 ${
    sticky ? "sticky-navbar shadow-md bg-base-200 dark:bg-slate-900 dark:text-white duration-200 transition-all ease-in-out" : ""
  }`}
>
        <div className="navbar mx-5">
         ...
         ><a onClick={()=>document.getElementById("my_modal_2").showModal()}>Login</a>
         <Login/>
         </button>
